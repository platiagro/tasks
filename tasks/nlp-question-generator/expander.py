...
class DocExpander:
    ...
    def expand_sql(self,df,context_column_name='context',questions_column_name = 'questions',expanded_text_column_name = "expanded_context" ):
        """
        ...
        df_copy.insert(df.shape[1], expanded_text_column_name , expanded_context_list)
