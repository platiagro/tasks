...
#df["Area de atuacao [Funcionario]"] = label_encoder.fit_transform(df["Area de atuacao [Funcionario]"])
#df["Especialidade medica"] = label_encoder.fit_transform(df["Especialidade medica"])

#df["Tempo de Dispensa (dias)"]= pd.to_numeric(df["Tempo de Dispensa (dias)"], errors='coerce')
#df["Tempo de Entrega"]= pd.to_numeric(df["Tempo de Entrega"], errors='coerce')
