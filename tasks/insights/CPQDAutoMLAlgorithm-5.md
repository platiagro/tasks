...
<p><img src="insights/markdown_generator/CPQDAutoMLAlgorithm-5/figures/5fef8cba-b519-41ea-b74a-def0519132b6.png" alt="Visualização dos outliers: DBscan" /></p>
...
<p><img src="insights/markdown_generator/CPQDAutoMLAlgorithm-5/figures/5edbb3ca-a911-4dd5-a966-30a3421f0234.png" alt="Visualização dos outliers: Isolation Forest" /></p>
...
<p>A melhor separação de grupos ocorreu nas features: ['Age', 'Spending Score (1-100)'] com uma quantidade de 4 grupos. A análise multidimensional em 2 dimensões fornece insights de quais features são mais importantes e que distinguem grupos entre si. Esta análise é realizada realizando a permutação das features do dataset.</p>
...
<tbody>
<tr>
<td align="left">Age - Spending Score (1-100)</td>
...
<tr>
<td align="left">Annual Income (k$) - Spending Score (1-100)</td>
...
<p><img src="insights/markdown_generator/CPQDAutoMLAlgorithm-5/figures/82ff7e0d-8ffe-4040-810c-22f32805f27e.png" alt="Diferença de Média entre População - Grupos" /></p>

<p><em>Diferença de Média entre População - Grupos</em></p>
<p><img src="insights/markdown_generator/CPQDAutoMLAlgorithm-5/figures/766e73b2-1516-459d-9cc4-bd6dfd79a397.png" alt="Diferença de Variância entre População - Grupos" /></p>

<p><em>Diferença de Variância entre População - Grupos</em></p>
<p>A maior diferença populacional positiva foi detectada na feature Spending Score (1-100) e no grupo 0, com valor de 22.17. A maior variação negativa foi na feature Spending Score (1-100) e no grupo 1, com o valor registrado de -16.83</p>
...
<p>Grupo 0: Média menor que a população: Age, Média maior que a população: Spending Score (1-100)</p>
<p>Grupo 1: Média maior que a população: Age, Média menor que a população: Spending Score (1-100)</p>
